...
class SortOptionDialog extends StatelessWidget {
      ...
      listItems.add(
        SizedBox(
          ...
          child: SelectableCard(
            ...
            onSelected: () => context.read<TabModelsProvider>().model!.setSortType(type),
      ...
      listItems.add(
        SizedBox(
          ...
          child: SelectableCard(
            ...
            onSelected: () => context.read<TabModelsProvider>().model!.setSortOrder(order),
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              context.read<TabModelsProvider>().model!.setSortOnlyThisFolder(!onlyThisFolder);
            },
            child: ListTile(
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ..._buildSortTypeItems(context, context.select<TabModelsProvider, SortType>((it) => it.model!.sortOption.type)),
        const Divider(thickness: 3),
        ..._buildSortOrderItems(context, context.select<TabModelsProvider, SortOrder>((it) => it.model!.sortOption.order)),
        _buildCheckBox(context, context.select<TabModelsProvider, bool>((it) => it.model!.sortOption.onlyThisFolder)),
      ],
    );
  }
}
